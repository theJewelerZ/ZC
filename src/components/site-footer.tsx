    ...
    <footer className="site-footer">
      <div className="site-container footer-grid">
        <div className="footer-brand">
          <Link href="/"><BrandMark surface="dark" /></Link>
        ...
        <div>
          ...
          <ul className="footer-links">
            <li><Link href="/simulator-construction">Simulator environment construction</Link></li>
            <li><Link href="/#planning-process">Planning process</Link></li>
            <li><Link href="/contact?service=simulator-construction">Request a consultation</Link></li>
          </ul>
        </div>
